"""
Command-line arguments for training, evaluation of metric estimation policies
"""
...
def get_args():
    ...
    parser.add_argument('--metric_type', type=str, default='relative_volume', choices=['relative_volume', 'surface_area'])
    # Agent options
